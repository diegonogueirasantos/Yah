using AutoMapper;
using Nest;
using Yah.Hub.Marketplace.LeroyMerlin.Application;
...
//AutoMapper
builder.Services.AddAutoMapper(typeof(Yah.Hub.Marketplace.LeroyMerlin.Application.Startup));

// call startups
new Yah.Hub.Marketplace.LeroyMerlin.Application.Startup(builder.Configuration).ConfigureServices(builder.Services);
