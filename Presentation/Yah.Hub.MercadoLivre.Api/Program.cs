...
//AutoMapper
builder.Services.AddAutoMapper(typeof(Yah.Hub.Marketplace.MercadoLivre.Application.Startup));

// call startups
new Yah.Hub.Marketplace.MercadoLivre.Application.Startup(builder.Configuration).ConfigureServices(builder.Services);
