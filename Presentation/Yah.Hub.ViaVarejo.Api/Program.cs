using AutoMapper;
using Nest;
using Yah.Hub.Marketplace.ViaVarejo.Application;
...
//AutoMapper
builder.Services.AddAutoMapper(typeof(Yah.Hub.Marketplace.ViaVarejo.Application.Startup));

// call startups
new Yah.Hub.Marketplace.ViaVarejo.Application.Startup(builder.Configuration).ConfigureServices(builder.Services);
