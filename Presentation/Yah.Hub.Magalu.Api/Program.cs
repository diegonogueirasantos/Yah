using AutoMapper;
using Nest;
using Yah.Hub.Marketplace.Magalu.Application;
...
//AutoMapper
builder.Services.AddAutoMapper(typeof(Yah.Hub.Marketplace.Magalu.Application.Startup));

// call startups
new Yah.Hub.Marketplace.Magalu.Application.Startup(builder.Configuration).ConfigureServices(builder.Services);
