using AutoMapper;
using Nest;
using Yah.Hub.Marketplace.B2W.Application;
...
//AutoMapper
builder.Services.AddAutoMapper(typeof(Yah.Hub.Marketplace.B2W.Application.Startup));

// call startups
new Yah.Hub.Marketplace.B2W.Application.Startup(builder.Configuration).ConfigureServices(builder.Services);
